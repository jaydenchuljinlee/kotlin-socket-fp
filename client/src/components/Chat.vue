        ...
        <div v-if="connected" class="flex flex-col h-[700px]">
          ...
          <div class="flex items-center justify-between p-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-gray-600"
                >연결됨: <strong class="text-gray-900">{{ userId }}</strong></span
              >
            </div>
          ...
          <div class="flex-1 overflow-auto p-6 bg-gray-50 space-y-4" ref="messageContainer">
            <div
              ...
              :key="index"
              :class="['max-w-[80%] break-words', isMyMessage(msg) ? 'ml-auto' : 'mr-auto']"
            >
              <div class="flex items-end gap-2">
                ...
                >
                  <div
                    class="text-xs mb-1"
                    :class="isMyMessage(msg) ? 'text-blue-100' : 'text-gray-500'"
                  >
                    {{ getSender(msg) }}
                  </div>
